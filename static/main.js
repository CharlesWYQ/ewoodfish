...
var bgmId = 0;
let count = 0;
let count_amount = localStorage.getItem("ewoodfish_count") || 0;
...
fetch('/api/count')
    ...
    .then(data => {
        ...
        document.getElementById('count_total').innerText = totalCount;
    });
...
function counter() {
    ...
    count++;
    count_amount++;
    localStorage.setItem("ewoodfish_count", count_amount);
